...
;
# (6) alch_current_tree
fstone_globcoord("alch_current_tree", "X_alch_current_tree", "Y_alch_current_tree", "921", "817", "Alchemy", "inspect current alchemy tree")
;
...
### Events ###
# (1) events_window_open
fstone_globcoord("events_window_open", "X_events_window_open", "Y_events_window_open", "412", "827", "Events", "open events window on battlefield screen")
;
# (2) event_slot_1
fstone_globcoord("event_slot_1", "X_event_slot_1", "Y_event_slot_1", "684", "416", "Events", "choose first event in list starting from top")
;
# (3) event_slot_2
fstone_globcoord("event_slot_2", "X_event_slot_2", "Y_event_slot_2", "681", "536", "Events", "choose second event in list starting from top")
;
# (4) event_slot_3
fstone_globcoord("event_slot_3", "X_event_slot_3", "Y_event_slot_3", "683", "660", "Events", "choose third event in list starting from top")
;
# (5) event_challenge_tab
fstone_globcoord("event_challenge_tab", "X_event_challenge_tab", "Y_event_challenge_tab", "809", "202", "Events", "challenge tab - works only for 3 days long mini events")
;
# (6) claim_event_loot_1
fstone_globcoord("claim_event_loot_1", "X_claim_event_loot_1", "Y_claim_event_loot_1", "1059", "431", "Events", "claim first loot - works only for 3 days long mini events")
;
# (7) claim_event_loot_2
fstone_globcoord("claim_event_loot_2", "X_claim_event_loot_2", "Y_claim_event_loot_2", "1058", "597", "Events", "claim second loot - works only for 3 days long mini events")
;
# (8) claim_event_loot_3
fstone_globcoord("claim_event_loot_3", "X_claim_event_loot_3", "Y_claim_event_loot_3", "1061", "764", "Events", "claim third loot - works only for 3 days long mini events")
;
...
;
# (10) guard_enlight
fstone_globcoord("guard_enlight", "X_guard_enlight", "Y_guard_enlight", "1128", "703", "Guardian", "guardian enlightenment button")
;
...
;
# (5) map_zoom_slide
fstone_globcoord("map_zoom_slide", "X_map_zoom_slide", "Y_map_zoom_slide", "940", "865", "Map", "bad map zoom slider is located close to minimum. because default value is not minimum and sometimes comes back.")
;
# (6) map_zoom_slide_dest
fstone_globcoord("map_zoom_slide_dest", "X_map_zoom_slide_dest", "Y_map_zoom_slide_dest", "904", "866", "Map", "drop the slider close to the left end of minus sign.")
;
...
;
# (23) check_armor_login_ul
fstone_globcoord("check_armor_login_ul", "x_check_armor_login_ul", "y_check_armor_login_ul", "655", "137", "StartQuit", "detect auto logout from armor games on firestone launch")
;
# (24) check_armor_login_br
fstone_globcoord("check_armor_login_br", "x_check_armor_login_br", "y_check_armor_login_br", "708", "170", "StartQuit", "detect auto logout from armor games on firestone launch")
;
# (25) go_armor_login_screen
fstone_globcoord("go_armor_login_screen", "X_go_armor_login_screen", "Y_go_armor_login_screen", "679", "153", "StartQuit", "go to armor games login screen on firestone launch")
;
# (26) armor_login_button
fstone_globcoord("armor_login_button", "X_armor_login_button", "Y_armor_login_button", "664", "621", "StartQuit", "armor games login button in login screen - uid and passwd are assumed to be saved in browser")
;
# (27) firefox_home_page
fstone_globcoord("firefox_home_page", "X_firefox_home_page", "Y_firefox_home_page", "95", "88", "StartQuit", "home page button is required on startup when last session crashed - session restore messes up with restoring view")
;
...
;
# (16) scarab_shop
fstone_globcoord("scarab_shop", "X_scarab_shop", "Y_scarab_shop", "1252", "672", "Tavern", "scarab shop")
;
# (17) scarab_claim_free
fstone_globcoord("scarab_claim_free", "X_scarab_claim_free", "Y_scarab_claim_free", "488", "699", "Tavern", "claim daily scarab token for free")
;
